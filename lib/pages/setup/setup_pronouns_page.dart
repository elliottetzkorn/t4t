...
class SetupPronounsPage extends ConsumerStatefulWidget {
  const SetupPronounsPage({super.key, required this.profile});

  final ProfileData profile;

  @override
  ConsumerState<SetupPronounsPage> createState() => _SetupPronounsPageState();
}

class _SetupPronounsPageState extends ConsumerState<SetupPronounsPage> {
  var _saving = false;
  ...
  Future<dynamic> _updateProfile() async {
    ...
    await ref.read(profileProvider.notifier).updatePronouns(pronouns).then((_) {
      ref
          .read(routerProvider)
          .toProfileSetup(widget.profile.copyWith(pronouns: pronouns), ref);
    });
                    ...
                    children: [
                      LimitedLengthTextFormField(
                          ...
                          title: AppLocalizations.of(context)!
                              .setup_pronouns_title,
                          hint: AppLocalizations.of(context)!
                              .setup_pronouns_subtitle,
